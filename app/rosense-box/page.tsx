  ...
  return (
    <div className="min-h-screen bg-white text-slate-700 selection:bg-[#10B981] selection:text-white">
      ...
      <main className="pt-24">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center max-w-4xl mx-auto space-y-6">
              <div className="inline-flex items-center gap-2 bg-[#10B981]/15 text-[#10B981] border border-[#10B981]/30 px-4 py-1.5 rounded-full text-xs font-mono font-bold uppercase tracking-wider shadow-inner">
                ...
                <span>The RoSense Box — Sovereign Enterprise Intelligence</span>
              </div>

              <h1 className="text-4xl sm:text-6xl font-bold tracking-tight text-white leading-[1.15]">
                Your company&apos;s memory. <br className="hidden sm:inline" />
              ...
              <p className="text-lg sm:text-xl text-slate-300 leading-relaxed font-normal max-w-3xl mx-auto">
                Intelligence that never leaves your building. High-performance on-premise hardware pre-configured for complete data sovereignty.
              </p>
              ...
              <div className="pt-6 flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                >
                  <span>Experience the RoSense Box</span>
        ...
        {/* SECTION 1: WHO IS ROSENSE BOX BUILT FOR? (ACT I START) */}
            ...
            <div className="grid lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-7 grid sm:grid-cols-2 gap-4">
                {[
                  ...
                  <div key={idx} className="p-5 rounded-2xl bg-white border border-slate-200 space-y-2 hover:border-slate-300 transition-all shadow-sm">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="p-8 rounded-3xl bg-slate-950 text-white border border-slate-800 shadow-xl space-y-6">
                <div className="flex items-center gap-3 pb-4 border-b border-slate-800">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-white">Organizations Choosing RoSense Box</h3>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                { name: "RoSense Box", badge: "Flagship Appliance", featured: true, desc: "Dedicated physical turnkey server pre-configured with offline models for your local LAN." },
                ...
                <div
                  ...
                  className={`p-6 rounded-2xl border flex flex-col justify-between ${
                    model.featured
                      ? "bg-slate-950 text-white border-[#10B981] shadow-xl ring-1 ring-[#10B981]/30"
        ...
        {/* SECTION 5: INTERACTIVE DATA FLOW (ACT II START) */}
        <section id="data-flow" className="py-24 bg-slate-950 text-white relative border-b border-slate-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-16 space-y-3">
              <span className="text-xs font-mono font-bold text-[#10B981] uppercase tracking-wider">
                Zero Data Footprint
            ...
            <div className="bg-slate-900 text-white p-8 rounded-3xl border border-slate-800 shadow-2xl relative overflow-hidden">
              <div className="grid md:grid-cols-7 gap-4 text-center items-center relative z-10">
                {[
                  ...
                  { step: "07", title: "Instant Search", sub: "Private retrieval" },
                ].map((item, idx) => (
                  <div key={idx} className="space-y-2 p-3 rounded-xl bg-slate-950 border border-slate-800">
              ...
              <div className="mt-8 pt-6 border-t border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-slate-400">Zero packets sent to public cloud servers or external APIs.</div>
                  </div>
                </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                { title: "Private Networking & SSO", icon: Building2, desc: "Seamless SAML / Active Directory SSO integration over your internal network." },
        ...
        <section id="specs" className="py-24 bg-slate-950 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-16 space-y-3">
              ...
              <p className="text-base text-slate-300">
                RoSense Box configurations are sized based on your expected meeting volume, concurrent users, and retention requirements.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              ...
              <div className="p-6 rounded-2xl bg-slate-900 border border-[#10B981] shadow-xl relative space-y-4">
                ...
                <div className="pt-2 border-t border-slate-800 space-y-2 text-xs text-slate-300">
                  ...
                  <div className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#10B981]" />
                    <span>Enhanced local vector search</span>
                  </div>
                </div>
              </div>
            ...
            <div className="grid lg:grid-cols-12 gap-8 items-stretch">
              <div className="lg:col-span-7 p-8 rounded-3xl bg-slate-900 border border-slate-800 space-y-6 flex flex-col justify-between">
                <div>
                  ...
                  <div className="grid sm:grid-cols-2 gap-3 text-xs text-slate-300">
                    {[
                      ...
                      "Physical Enterprise Appliance",
                      "100% On-Premise Air-Gapped Deployment",
                      "Turnkey Installation & Local Domain Setup",
                ...
                <div className="p-4 rounded-xl bg-slate-950 border border-slate-800 text-xs text-slate-400 leading-relaxed flex items-start gap-3 mt-4">
                  ...
                  <div>
                    ...
                    {" "}RoSense Box configurations are sized based on your expected meeting volume, concurrent users, and retention requirements. RoSense continuously evaluates advancements in hardware architecture to incorporate optimal enterprise-grade compute components while maintaining all committed platform capabilities.
                  </div>
                </div>
              </div>

              {/* Turnkey Commercial Card */}
              <div className="lg:col-span-5 p-8 rounded-3xl bg-slate-900 border border-[#10B981]/40 shadow-2xl flex flex-col justify-between space-y-6">
                <div>
            ...
            <div className="rounded-3xl bg-gradient-to-r from-slate-900 via-slate-900 to-emerald-950 border border-slate-800 p-10 sm:p-16 text-center relative overflow-hidden emerald-glow-sm">
              <div className="relative z-10 max-w-3xl mx-auto space-y-6">
                <h2 className="text-3xl sm:text-5xl font-bold tracking-tight text-white leading-tight">
                  Your strategy. Your data. <span className="text-gradient-emerald">Your control.</span>
                </h2>
                <p className="text-slate-300 text-base sm:text-lg">
                  Deploy the RoSense Box in your office network and keep every conversation inside your perimeter.
                </p>
                <div className="pt-4">
                  <Link
                    href="/company/contact"
