...
export const metadata = {
  title: "Pricing — RoSense Enterprise",
  description:
    "Transparent enterprise audio intelligence pricing tailored to your infrastructure, security requirements, and data sovereignty. Explore Private Box appliances, On-Prem GPU, and Cloud options.",
};
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="grid lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
                <div className="inline-flex items-center gap-1.5 bg-[#10B981]/10 text-[#10B981] border border-[#10B981]/30 px-4 py-1.5 rounded-full text-xs font-semibold uppercase tracking-wider">
                  <span>Transparent Enterprise Pricing</span>
                </div>

                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-slate-900 leading-tight">
                  Choose your path. <br />
                  <span className="text-gradient-emerald">No token metering. No surprises.</span>
                </h1>

                <p className="text-slate-600 text-base sm:text-lg max-w-2xl mx-auto lg:mx-0 leading-relaxed font-normal">
                  From turnkey air-gapped appliances to low-friction cloud evaluation. Transparent pricing structured around your infrastructure, security, and team requirements.
                </p>

                <div className="pt-2 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                  <Link
                    href="#enterprise-pricing"
                    className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-slate-900 hover:bg-slate-800 text-white font-semibold px-7 py-4 rounded-xl transition-all shadow-lg text-sm"
                  >
                    <span>Deploy Private Box</span>
                    <ArrowRight className="w-4 h-4 text-[#10B981]" />
                  </Link>

                  <Link
                    href="#cloud-pricing"
                    className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-white hover:bg-slate-50 border border-slate-200 text-slate-900 font-semibold px-7 py-4 rounded-xl transition-all text-sm"
                  >
              ...
              <div className="lg:col-span-5">
                <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-2xl relative text-white">
                  <div className="text-xs font-mono uppercase tracking-wider text-slate-400 mb-4 pb-3 border-b border-slate-800 flex items-center justify-between">
                  ...
                  <div className="space-y-3">
                    {/* Node 1: Private Box */}
                    <div className="bg-slate-950 border border-emerald-500/40 rounded-xl p-4 flex items-center justify-between shadow-md">
        ...
        <section className="py-24 bg-slate-950 text-white border-t border-slate-800 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-4 text-center space-y-6 relative z-10">
            ...
            <h2 className="text-3xl sm:text-5xl font-bold text-white tracking-tight">
              Ready to capture your organization&apos;s memory?
            </h2>

            <p className="text-slate-300 text-base sm:text-lg max-w-2xl mx-auto leading-relaxed">
              Deploy RoSense securely inside your infrastructure. Every meeting transcribed, indexed, and made instantly searchable—with zero data leakage.
            </p>

            <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                href="/company/contact"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-[#10B981] hover:bg-[#059669] text-slate-950 font-bold px-8 py-4 rounded-xl transition-all shadow-lg text-sm"
              >
              ...
              <Link
                href="/company/contact"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-slate-900 hover:bg-slate-800 border border-slate-700 text-white font-semibold px-8 py-4 rounded-xl transition-all text-sm"
              >
